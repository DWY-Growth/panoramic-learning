...
const TESTIMONIALS_DATA = [
  ...
  { initials: 'KA', name: 'K.T.', text: `Just completed my A2 and Judith and her team are just awesome.` },
  ...
  { initials: 'CP', name: 'C.S.', text: `I just love Panoramic Learning! The lessons are laid out well; the online learning material is easy to use and structured properly and the tutors are very knowledgeable and friendly. You are sure to be speaking Dutch with them in no time!` },
